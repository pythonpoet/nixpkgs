...
<<<<<<< HEAD:pkgs/desktops/xfce/core/xfce4-settings/default.nix
  meta = {
    description = "Settings manager for Xfce";
    teams = [ lib.teams.xfce ];
||||||| 213fed0310e3:pkgs/desktops/xfce/core/xfce4-settings/default.nix
  meta = with lib; {
    description = "Settings manager for Xfce";
    teams = [ teams.xfce ];
=======
  ...
  passthru.updateScript = gitUpdater {
    ...
    odd-unstable = true;
>>>>>>> master:pkgs/by-name/xf/xfce4-settings/package.nix
  };
