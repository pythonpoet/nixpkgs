...
<<<<<<< HEAD:pkgs/desktops/xfce/core/xfce4-power-manager/default.nix
  meta = {
    description = "Power manager for the Xfce Desktop Environment";
    teams = [ lib.teams.xfce ];
||||||| 213fed0310e3:pkgs/desktops/xfce/core/xfce4-power-manager/default.nix
  meta = with lib; {
    description = "Power manager for the Xfce Desktop Environment";
    teams = [ teams.xfce ];
=======
  ...
  passthru.updateScript = gitUpdater {
    ...
    odd-unstable = true;
>>>>>>> master:pkgs/by-name/xf/xfce4-power-manager/package.nix
  };
