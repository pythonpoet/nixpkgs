...
<<<<<<< HEAD:pkgs/desktops/xfce/core/xfce4-panel/default.nix
  meta = {
    description = "Panel for the Xfce desktop environment";
    teams = [ lib.teams.xfce ];
||||||| 213fed0310e3:pkgs/desktops/xfce/core/xfce4-panel/default.nix
  meta = with lib; {
    description = "Panel for the Xfce desktop environment";
    teams = [ teams.xfce ];
=======
  ...
  passthru.updateScript = gitUpdater {
    ...
    odd-unstable = true;
>>>>>>> master:pkgs/by-name/xf/xfce4-panel/package.nix
  };
