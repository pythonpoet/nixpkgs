...
<<<<<<< HEAD:pkgs/development/tools/build-managers/build2/default.nix
  meta = {
    homepage = "https://www.build2.org/";
||||||| 213fed0310e3:pkgs/development/tools/build-managers/build2/default.nix
  meta = with lib; {
    homepage = "https://www.build2.org/";
=======
  meta = {
    inherit (build2-bootstrap.meta)
      ...
      maintainers
      ;
>>>>>>> master:pkgs/by-name/bu/build2/package.nix
