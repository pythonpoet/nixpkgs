...
<<<<<<< HEAD:pkgs/applications/misc/digitalbitbox/default.nix
    license = lib.licenses.mit;
    maintainers = with lib.maintainers; [
      vidbina
    ];
    platforms = lib.platforms.linux;
||||||| 213fed0310e3:pkgs/applications/misc/digitalbitbox/default.nix
...
=======
    license = lib.licenses.mit;
    platforms = lib.platforms.linux;
>>>>>>> master:pkgs/by-name/di/digitalbitbox/package.nix
  };
})
