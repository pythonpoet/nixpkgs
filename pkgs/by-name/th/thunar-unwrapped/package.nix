...
<<<<<<< HEAD:pkgs/desktops/xfce/core/thunar/default.nix
  meta = {
    description = "Xfce file manager";
    mainProgram = "thunar";
    teams = [ lib.teams.xfce ];
||||||| 213fed0310e3:pkgs/desktops/xfce/core/thunar/default.nix
  meta = with lib; {
    description = "Xfce file manager";
    mainProgram = "thunar";
    teams = [ teams.xfce ];
=======
  passthru.updateScript = gitUpdater {
    rev-prefix = "thunar-";
    odd-unstable = true;
>>>>>>> master:pkgs/by-name/th/thunar-unwrapped/package.nix
  };
