...
<<<<<<< HEAD:pkgs/development/libraries/libffi/default.nix
    license = lib.licenses.mit;
    maintainers = with lib.maintainers; [ matthewbauer ];
    platforms = lib.platforms.all;
||||||| 213fed0310e3:pkgs/development/libraries/libffi/default.nix
...
=======
    ...
    maintainers = [ ];
    platforms = lib.platforms.all;
>>>>>>> master:pkgs/by-name/li/libffiReal/package.nix
