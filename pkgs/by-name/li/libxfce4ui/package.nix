...
<<<<<<< HEAD:pkgs/desktops/xfce/core/libxfce4ui/default.nix
  meta = {
||||||| 213fed0310e3:pkgs/desktops/xfce/core/libxfce4ui/default.nix
  meta = with lib; {
=======
  ...
  meta = {
>>>>>>> master:pkgs/by-name/li/libxfce4ui/package.nix
