...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  meta = {
    ...
    mainProgram = "prisma";
<<<<<<< HEAD:pkgs/by-name/pr/prisma-engines/package.nix
    maintainers = with lib.maintainers; [
      tomhoule
||||||| 213fed0310e3:pkgs/by-name/pr/prisma-engines/package.nix
    maintainers = with maintainers; [
      tomhoule
=======
    maintainers = with lib.maintainers; [
>>>>>>> master:pkgs/by-name/pr/prisma-engines_6/package.nix
      aqrln
    ];
  };
})
