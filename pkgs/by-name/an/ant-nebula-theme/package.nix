...
<<<<<<< HEAD:pkgs/data/themes/ant-theme/ant-nebula.nix
    license = lib.licenses.gpl3;
    platforms = lib.platforms.all;
    maintainers = with lib.maintainers; [ alexarice ];
||||||| 213fed0310e3:pkgs/data/themes/ant-theme/ant-nebula.nix
...
=======
    ...
    platforms = lib.platforms.all;
    maintainers = with lib.maintainers; [ alexarice ];
>>>>>>> master:pkgs/by-name/an/ant-nebula-theme/package.nix
  };
})
