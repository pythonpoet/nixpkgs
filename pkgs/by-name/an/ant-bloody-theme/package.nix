...
<<<<<<< HEAD:pkgs/data/themes/ant-theme/ant-bloody.nix
    license = lib.licenses.gpl3;
    platforms = lib.platforms.all;
    maintainers = with lib.maintainers; [ alexarice ];
||||||| 213fed0310e3:pkgs/data/themes/ant-theme/ant-bloody.nix
...
=======
    ...
    platforms = lib.platforms.all;
    maintainers = with lib.maintainers; [ alexarice ];
>>>>>>> master:pkgs/by-name/an/ant-bloody-theme/package.nix
  };
})
