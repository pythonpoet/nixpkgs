...
<<<<<<< HEAD:pkgs/data/icons/beauty-line-icon-theme/default.nix
    platforms = lib.platforms.linux;
    license = [ lib.licenses.publicDomain ];
    maintainers = with lib.maintainers; [ lwb-2021 ];
||||||| 213fed0310e3:pkgs/data/icons/beauty-line-icon-theme/default.nix
...
=======
    ...
    license = lib.licenses.publicDomain;
    maintainers = with lib.maintainers; [ lwb-2021 ];
>>>>>>> master:pkgs/by-name/be/beauty-line-icon-theme/package.nix
  };
}
