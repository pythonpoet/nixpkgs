...
<<<<<<< HEAD:pkgs/data/icons/gruvbox-dark-icons-gtk/default.nix
    license = lib.licenses.gpl3Only;
    platforms = lib.platforms.unix;
    maintainers = [ lib.maintainers.nomisiv ];
||||||| 213fed0310e3:pkgs/data/icons/gruvbox-dark-icons-gtk/default.nix
...
>>>>>>> master:pkgs/by-name/gr/gruvbox-dark-icons-gtk/package.nix
  };
})
