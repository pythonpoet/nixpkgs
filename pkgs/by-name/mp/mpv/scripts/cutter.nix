...
<<<<<<< HEAD:pkgs/applications/video/mpv/scripts/cutter.nix
    license = lib.licenses.mit;
    maintainers = with lib.maintainers; [ lom ];
||||||| 213fed0310e3:pkgs/applications/video/mpv/scripts/cutter.nix
    license = licenses.mit;
    maintainers = with maintainers; [ lom ];
=======
    license = lib.licenses.mit;
    maintainers = [ ];
>>>>>>> master:pkgs/by-name/mp/mpv/scripts/cutter.nix
  };
}
