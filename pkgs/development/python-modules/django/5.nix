...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "django";
    repo = "django";
<<<<<<< HEAD:pkgs/development/python-modules/django/5_2.nix
    rev = "refs/tags/${version}";
    hash = "sha256-9URe8hB15WP92AU1YgGGFfZhVxn59gfBRrORZ04L+F0=";
||||||| 213fed0310e3:pkgs/development/python-modules/django/5_2.nix
    rev = "refs/tags/${version}";
    hash = "sha256-ruzQ3CUNqHa0RmxCDBVXbtetkMvz+G/D4/LB/2aBc8I=";
=======
    tag = version;
    hash = "sha256-9URe8hB15WP92AU1YgGGFfZhVxn59gfBRrORZ04L+F0=";
>>>>>>> master:pkgs/development/python-modules/django/5.nix
  };
